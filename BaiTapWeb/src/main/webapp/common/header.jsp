...
<body>
	<!-- Navigation-->
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="#"><img src="<%=url %>/gui/images/navbar-logo.svg" alt="..." /></a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                        ...
                        <li class="nav-item">
                        	<!--  <a class="nav-link" href="<%=url %>/views/categories.jsp">Danh mục sản phẩm</a>-->
                        	<a class="nav-link" href="<%=url %>/UploadCategoriesController">Danh mục sản phẩm</a>
                        </li>
